...
urlpatterns = [
    ...
    path('changeattr/', UserChangeAttrModelViewSet.as_view({'patch':'partial_update'}), name='changeattr'),
    path('changepassword/', UserChangePasswordModelViewSet.as_view({'patch':'partial_update'}), name='changepassword'),
]